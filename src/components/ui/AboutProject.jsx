...
function List({ icon, header, text }) {
  return (
    <li className="flex gap-2">
      <span className="flex text-2xl bg-purple-500/20 p-1.5 rounded-lg">
        {icon}
      </span>
      <div>
  ...
  return (
    <div className="text-white hidden xl:flex flex-col gap-6 max-w-[500px]">
      ...
      <p className="text-xl text-slate-300">
        Join thousands of developers competing on programming challenges across
        multiple languages and topics.
      </p>
      <ul className="flex flex-col gap-3">
        <List
          icon={"🎯"}
          header={"100+ Questions"}
          text={"Across 7 programming categories"}
        />
        <List
          icon={"🏆"}
